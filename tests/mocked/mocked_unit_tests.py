...
from app import add_user, add_event_info
...
class AddUserTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.success_test_params = [
            {
                KEY_INPUT : ['123456', 'Benjamin'],
                KEY_EXPECTED : None
            },
            {
                KEY_INPUT : ['12488595020', 'GroupTree'],
                KEY_EXPECTED : None
            },
            {
                KEY_INPUT : ['9993338884477', 'Jane Doe'],
                KEY_EXPECTED : None
            }
        ]
        ...
        self.failure_test_params = [
            {
                KEY_INPUT : ['59900234', 'Ben'],
                KEY_EXPECTED : True
            },
            {
                KEY_INPUT : ['545461231', 'GroupBore'],
                KEY_EXPECTED : False
            },
            {
                KEY_INPUT : ['99266673427', 'Harry The Dog'],
                KEY_EXPECTED : "Jane Doe"
            }
        ]
...
class AddEventTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.success_test_params = [
            {
                KEY_INPUT : ["Benjamin", "admin", "shopping", "2021-05-20 05:20:00",
                            "123456", "monthly", 3],
                KEY_EXPECTED : None
            },
            {
                KEY_INPUT : ["johnny", "test", "lifting", "2021-04-20 04:20:00",
                            "666666", "daily", 3],
                KEY_EXPECTED : None
            },
            {
                KEY_INPUT : ["Alex", "the great", "running", "2021-06-20 06:20:00",
                            "777777", "weekly", 3],
                KEY_EXPECTED : None
            }
        ]
        ...
        self.failure_test_params = [
            {
                KEY_INPUT : [123, "admin", "lifting", "2021-05-20 05:20:00",
                            "123456", "monthly", 3],
                KEY_EXPECTED : 123
            },
            {
                KEY_INPUT : ["1234", "test", "running", "2021-04-20 04:20:00",
                            "8888", "daily", 2],
                KEY_EXPECTED : True
            },
            {
                KEY_INPUT : [False, "the great", "shopping", "2021-06-20 06:20:00",
                            "777777", "weekly", 1],
                KEY_EXPECTED : False
            }
        ]
